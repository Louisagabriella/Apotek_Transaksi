...
import pack.transaksi.KoneksiDB;
...
public class form_pembayaran extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TRANSAKSI APOTEK");
        jPanel2.add(jLabel1);
        jLabel1.setBounds(340, 0, 444, 50);
        ...
        akhir.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Kode Transaksi", "Nama Petugas", "Kode Obat", "Jenis Transaksi", "Tanggal Resep", "Tanggal Beli", "Harga Obat", "TotalPembayaran"
            }
        ) {
    ...
    private void refreshData() {
        String kolom[] = {"Kode Transaksi","Nama Petugas","Kode Obat","Jenis Transaksi","Tanggal Resep","Tanggal Beli","Harga Obat","Total Pembayaran"};
        ...
        try {
            while(rs.next()) {
                ...
                if ("L".equals(rs.getString(4))){
                    jenis_kendaraan = "Resep";
                } else {
                    jenis_kendaraan = "Tanpa Resep";
                }
